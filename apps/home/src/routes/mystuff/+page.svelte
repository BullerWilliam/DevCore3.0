...
<main class="info-page">
    <div class="info-card">
        ...
        <h1>My Stuff</h1>
        <p>
            Project management, uploads, and saved account work still live in the legacy studio
            while DevCore is being unified into one public deployment.
        </p>
        <p>
            This bridge page keeps the DevCore navigation working and gives you a clear handoff
