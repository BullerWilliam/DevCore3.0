...
/*!*********************************************************************************************************!*\
  !*** C:/Users/timmi/Documents/GitHub/DevCore3.0/node_modules/raw-loader!./src/addons/gamepad/style.css ***!
  \*********************************************************************************************************/
...
const run = _ref => {
  let scaffolding = _ref.scaffolding,
...
const run = _ref => {
  ...
  const postMouseData = (e, isDown) => {
    ...
    const _scaffolding$layersRe = scaffolding.layersRect,
      width = _scaffolding$layersRe.width,
      height = _scaffolding$layersRe.height;
  ...
  vm.runtime._step = function () {
    ...
    const _scaffolding$layersRe2 = scaffolding.layersRect,
      width = _scaffolding$layersRe2.width,
      height = _scaffolding$layersRe2.height;
